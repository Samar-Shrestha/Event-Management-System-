<?php
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(isset($_SESSION['admin']))
				{
					$qry1=mysqli_query($con,"INSERT INTO wedding(img,nm,price,location,rating,capacity,venue_type,space_preference)VALUES('$fnm','$nm','$pr','$location','$rating','$capacity','$venue_type','$space_preference')");
					if($qry1)
					{
...
<div class="grid_3 grid_4">
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control1"  name="venue_type" id="focusedinput" placeholder="Venue Type (e.g., Banquet Hall)" required>
								</div>
							</div>
							<div class="form-group">
					...
					<input type="button" value="DISPLAY" class="btn my" onClick="window.location.href='wed_disp.php'" />
					</div>
					</form>
					</div>
				</div>
