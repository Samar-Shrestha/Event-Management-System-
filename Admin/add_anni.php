<?php
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(isset($_SESSION['admin']))
				{
					$qry1=mysqli_query($con,"INSERT INTO anniversary(img,nm,price,location,rating,capacity,venue_type,space_preference)VALUES('$fnm','$nm','$pr','$location','$rating','$capacity','$venue_type','$space_preference')");
					if($qry1)
					{
