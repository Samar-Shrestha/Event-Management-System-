...
<div class="gallery-container-wrapper">
	<aside class="filter-sidebar">
		...
		<div class="filter-content">
			<form method="GET" action="bday_gal.php" id="filterForm">
		...
		<div class="services-content">
			...
			<a href="bday_gal.php" class="service-item-link"><div class="service-item active-service">Birthday Party</div></a>
			<a href="anni_gal.php" class="service-item-link"><div class="service-item">Anniversary</div></a>
			<a href="other_gal.php" class="service-item-link"><div class="service-item">Entertainment</div></a>
		</div>
		<div class="filter-content">
			<a href="bday_gal.php" class="btn-reset-filters">Reset Filters</a>
		</div>
	</aside>
	...
	<div class="gallery-main-content">
		<div class="container" style="max-width: 100%; width: 100%; padding: 0;">
			...
			<?php
				...
				$qry_all = "SELECT * FROM birthday WHERE 1=1";
			...
			<div class="gallery-grids-top">
				<h3 class="category-title">Birthday Party Venues & Services (<?php echo $count_all; ?> Results)</h3>
				<div style="display: flex; flex-wrap: wrap; gap: 20px;">
				<?php
					if($count_all == 0){
						echo "<div style='width:100%;padding:40px;text-align:center;'><div style='background:white;padding:40px;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1);'><h3 style='color:#8B2E2E;margin-bottom:10px;'>No venues found</h3><p style='color:#666;'>Try adjusting your filters to see more results.</p><a href='bday_gal.php' style='display:inline-block;margin-top:20px;padding:12px 30px;background:#8B2E2E;color:white;text-decoration:none;border-radius:6px;'>Reset Filters</a></div></div>";
					}
				...
				<div style="width: 100%; margin-bottom: 25px;">
					<div class="venue-card">
						<div class="venue-image">
							<a class="example-image-link" href="images/<?php echo $row['img']; ?>" data-lightbox="bday-set">
						...
						<div class="venue-details">
							<div>
								...
								<div class="venue-rating">
									<?php
									for($i = 1; $i <= 5; $i++){
										echo ($i <= $rating) ? '<span style="color:#FFA500;">★</span>' : '<span style="color:#ddd;">★</span>';
									}
							...
							<div>
								<a href="book_birthd.php?id=<?php echo $row['id']; ?>" class="details-btn">DETAILS</a>
							</div>
						</div>
					</div>
				</div>
