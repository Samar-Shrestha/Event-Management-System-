...
if ($id > 0) {
    ...
    if ($check_view && mysqli_num_rows($check_view) == 0) {
        mysqli_query($con, "UPDATE otherevent SET view_count = view_count + 1 WHERE id = $id");
...
if (isset($_POST['submit'])) {
    ...
    if ($q) {
        ...
        $qr1 = mysqli_query($con, "INSERT INTO temp (img, nm, price, user_session, event_type) 
                                   VALUES ('$image', '$name', $price, '$session_id', 'otherevent')");
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">    
                <a href="other_gal.php" class="btn btn-default">← BACK TO ENTERTAINMENT</a>                    
            </div> 
            <form method="post">
                <div class="modal-body">
                    ...
                    <p>
                        ...
                        <strong>Description:</strong> Special entertainment event theme<br/><br/>
